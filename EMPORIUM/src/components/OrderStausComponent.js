...
import { View, Text, FlatList, Image, ScrollView, Platform } from 'react-native'
        ...
        <View>
            <View style={{ marginTop: HEIGHT * 0.02, marginHorizontal: HEIGHT * 0.02 }}>
                <View style={{ flexDirection: "row", alignItems: "center" }} >
                    ...
                    <View style={[{ borderWidth: Platform.OS === "ios" ? 1.7 : 2, height: 1, width: WIDTH * 0.23, borderColor: "#B89962" }]} />
                    <View style={[{ justifyContent: "center", alignItems: "center", height: WIDTH * 0.04, width: WIDTH * 0.04, borderRadius: WIDTH * 0.4 / 2, borderColor: "#B89962", borderWidth: 2, backgroundColor: "#B89962" }]} >
                        <Image source={smallWhiteTick} />
                    </View>
                    <View style={[{ borderWidth: Platform.OS === "ios" ? 1.7 : 2, height: 1, width: WIDTH * 0.23, borderColor: "#B89962" }]} />
                    ...
                    <View style={[{ borderWidth: Platform.OS === "ios" ? 1.7 : 2, height: 1, width: WIDTH * 0.23, borderColor: "#DFE1DE" }]} />
