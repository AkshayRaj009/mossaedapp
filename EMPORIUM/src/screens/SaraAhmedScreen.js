    ...
    <View style={{ alignItems: "center" }} >
      ...
      <View style={{ marginHorizontal: 10, height: HEIGHT * 0.580 }}>
        <FlatList
          ...
          renderItem={({ item }) =>
            <View style={{ marginHorizontal: HEIGHT * 0.02, backgroundColor: "#ffff", height: Platform.OS === 'ios' ? 244 : 256, marginTop: HEIGHT * 0.02 }} >
              <Image source={item.image} />
              <View style={{ marginHorizontal: HEIGHT * 0.02 }} >
                <View style={{ justifyContent: "center", alignItems: "center", height: WIDTH * 0.08, width: WIDTH * 0.08, borderRadius: WIDTH * 0.8 / 2, borderWidth: 2, backgroundColor: "#fff", position: "absolute", left: HEIGHT * 0.10, bottom: Platform.OS === 'ios' ? 35 : 39, borderColor: "#fff" }} >
