...
import { estateFilter } from "../constants/FlatListArray"

const LandFilterScreen = ({navigation}) => {
    return (
        <>
            ...
            <ButtonComponent navigation={() => navigation.navigate("LandScreen")} style={{ marginTop: HEIGHT * 0.12, height: HEIGHT * 0.08 }} titleStyle={{ fontSize: 13, color: "black" }} title="View Land" />
        </>
    )
}

export default LandFilterScreen