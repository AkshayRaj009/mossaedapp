...
import { rightBackArrow, firstProperty, crossIcon, drawerIcon, alRay } from "../assests/index"
import { colors } from "../constants/colors"
import { HEIGHT, WIDTH } from '../constants/Dimensions'
import { bank, carlistData, property } from "../constants/FlatListArray"
import CarListComponent from '../component/CarListComponent'
import MainContainer from '../component/MainContainer'

const AlrayyanScreen = ({navigation}) => {
        const slideshow = (type) => {
            switch (type) {
                case "first":
                    return <View>
                        <Image style={{ width: WIDTH, marginTop: 0, zIndex: -1, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, height: HEIGHT * 0.44 }} source={alRay} />
  ...
  return (
    ...
    <MainContainer navigation={() => navigation.goBack()} leftLogo={rightBackArrow} titleStyle={{ color: colors.darkWhite, fontSize: 20, marginTop: HEIGHT * 0.04 }} title="Bank" image={drawerIcon} color={{ backgroundColor: colors.Yellow, marginTop: 0, height: HEIGHT * 0.09 }} style2={{}} backStyle={{ marginTop: HEIGHT * 0.03 }} text="Watches and Jewelry" >
        <FlatList
            pagingEnabled
