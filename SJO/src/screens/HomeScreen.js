...
const HomeScreen = (props) => {
    ...
    return (
        <MainContainer titleStyle={{ marginLeft: WIDTH * 0.08, color: colors.Yellow }} title="Home" image={homeLeftIcon} leftImage={spalshLeftImage} color={{ backgroundColor: colors.darkWhite }} >
            <View style={{ backgroundColor: colors.darkWhite, height: HEIGHT * 0.20, borderBottomRightRadius: 26, borderBottomLeftRadius: 26 }} >
